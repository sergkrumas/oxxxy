...
### Версия 0.94 (дата не определена)
  ...
  - внедрение Panning & Zooming для холста в редакторе
      ...
      - при рефакторинге забыл задать смещение финальной отрисовки на координаты верхнего левого угла области захвата, из-за область захвата съезжала к началу координат в левый верхний угол
      - в режиме дебага (`DEBUG=True`) больше не отображается оверлей результата. Посмотреть на то, что в данный момент получается в чистовом виде можно нажав на клавишу P (закрытие через эту же клавишу)
      - фикс краша: клавишу P не отображал результат без заданной области захвата
      - написал маппинг координат курсора мыши во время клика на координаты холста
