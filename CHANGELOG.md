...
### Версия 0.95 (дата не определена): UX и новые инструменты
  ...
  - новая команда в контекстном меню для расставления элеменртов рядами и столбцами
      ...
      - перед этим следует воспользовать командой «Автоколлаж». Результат размещения будет зависеть от выбора опации в команде «Автоколлаж»
      - пока хорошо это всё работает, если картинки одинаковой ширины и высоты, обработка исключения из этого правила ещё не прописаны
