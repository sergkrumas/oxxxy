...
### Версия 0.93 (дата не определена)
  ...
  - Пофиксил баг: после использования инструмента, который делает картинку из пререндера, при последующем запуске клик по любой области выдаёт вылет. Но перед этим показывается менюха превьюшек. 
