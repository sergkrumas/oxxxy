...
### Версия 0.94 (дата не определена)
  ...
  - внедрение Panning & Zooming для холста в редакторе (продолжение)
      ...
      - восстановлена работа инструментов «Карандаш» и «Маркер», оба поддерживают новое выделение, собственные трансформации и трансформации сцены
      - восстановлена работа инструмента «Стрелка» с поддержкой нового выделения, собственных трансформаций и трансформации сцены
      ...
      - восстановлена работа инструмента «Прямоугольник» с поддержкой нового выделения, собственных трансформаций и трансформация сцены
      - восстановлена работа инструмента «Нумерация» с поддержкой нового выделения, собственных трансформаций и трансформации сцены
      - восстановлена работа инструмента «Размытие» с поддержкой нового выделения, собственных трансформаций и трансформации сцены
      - восстановлена работа инструмента «Затемнение» с поддержкой нового выделения, собственных трансформаций и трансформации сцены
