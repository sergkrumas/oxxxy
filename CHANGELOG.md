...
## Что планируется сделать дальше?
  - **Основное на 2024**
      ...
      - UX: несколько идей по поводу цикла жизни приложения
...
### - (15 фев 25) назрел пересмотр всего UX, чтобы и бесячие баги исправить, и окончательно сплавить нарощенный функционал с основным. Весной этим и займёмся
  ...
  - (29 сен 25) в окошко уведомения о создании скриншота внизу добавлена четвёртая кнопка, которая позволяет открыть её в редакторе Oxxxy
