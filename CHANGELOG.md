...
### Версия 0.95 (дата не определена): UX и новые инструменты
  ...
  - инструмент «Дерево стрелок»
      ...
      - UX: больше не нужно выделять узел, чтобы новый узел был соединён с выделенным. Теперь достаточно просто начать нанесение нового узла из той позиции, где находится нужный узел. Нужный узел выбирается по принципу близости
