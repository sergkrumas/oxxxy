...
### Версия 0.94 (дата не определена)
  ...
  - внедрение Panning & Zooming для холста в редакторе
      ...
      - на примере инструмента Трансформация реализовано выделение и перетаскивание пометок, пока только для пометок типа Линия. Заодно частично удалён старый код
  ...
  - внедрение Panning & Zooming для холста в редакторе (продолжение)
      - на примере инструмента Трансформация реализовано вращение пометок (пока только для пометок типа Линия)
