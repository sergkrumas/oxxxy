...
### Версия 0.94 (дата не определена)
  ...
  - внедрение PZMT (Canvas Panning & Zooming и Elements Multiselect & Transformations) для холста в редакторе (продолжение)
      ...
      - исправлег баг: для прямых пометок (`Element.straight`) иногда получался неудачный слишком узкий selection_box для целей выделения. Правильность поправки доказывается проведением восьми линий из импровизированного центра в стороны с шагом 45 градусов
