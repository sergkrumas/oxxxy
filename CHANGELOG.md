...
### Версия 0.94 (дата не определена)
  ...
  - внедрение PZMT (Canvas Panning & Zooming и Elements Multiselect & Transformations) для холста в редакторе (продолжение)
      ...
      - инструмент «Содержимое в фон» переименован в «Нарисовать содержимое на фоне и удалить содержимое»
      - инструмент «Нарисовать содержимое на фоне и удалить содержимое» восстановлен в рамках PZMT
          - содержимое не удаляется, просто история отматывается так, чтобы видно было только фон
