...
## Что планируется сделать дальше?
  - **Основное на 2024**
      ...
      - добавить возможность записывать видео со звуком или гифки в захваченной области (фон в таком случае не рисуется вообще, работает только виджет захвата, возможно потребуется создание расширения языке Си)
  - **Подготовка к релизу**
