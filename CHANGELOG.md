...
### Версия 0.94 (дата не определена)
  ...
  - внедрение Panning & Zooming для холста в редакторе
      ...
      ---------------------- 2024 ----------------------
      - отрисовка элемента для инструмента line переписана так, чтобы отражать перемещение, повороты и масштабирование элемента при всём этом реагируя на перемещение и масштабирование вьюпорта. До этого поддерживалось лишь перемещение вьюпорта и перемещение элемента
