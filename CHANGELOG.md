...
### Версия 0.94 (19 марта 2024): панорамирование и зум для редактора; возможность выделения нескольких пометок; перемещение, вращение и масштабирование пометок; обновлённая система истории действий
  ...
  - внедрение PZMT (Canvas Panning & Zooming и Elements Multiselect & Transformations) для холста в редакторе (продолжение)
      ...
      - исправлен баг: для прямых пометок (`Element.straight`) с предвращением иногда получался неудачный слишком узкий selection_box для целей выделения. Правильность поправки доказывается проведением восьми линий из импровизированного центра в стороны с шагом 45 градусов
      - исправлен баг: для прямых пометок (`Element.straight`) с предвращением неправильно работало вращение по шагу 45 градусов относительно холста
