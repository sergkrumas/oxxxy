...
### Версия 0.95 (дата не определена): UX и новые инструменты
  ...
  - UX: аккуратная область выделения для пометок инструментов «Линия», «Карандаш», «Маркер», «Стрелка»
      ...
      - для инструментов «Карандаш» и «Маркер» полностью реализован алгоритм построения области выделения, в том числе когда они выпрямлены (`Element.straing==True`)
      - для инструмента «Линия» полностью реализован алгоритм построения области выделения
