...
### Версия 0.94 (дата не определена)
  ...
  - внедрение Panning & Zooming для холста в редакторе (продолжение)
      ...
      - восстановлена работа инструмента «Стрелка» с поддержкой нового выделения, собственных трансформаций и изменения вьюпорта
          - **виджет перестаёт работать, если стрелка вытянута строго по вертикали или горизонтали** (деление на ноль)
      - **пропускаю восстановление инструмента «Текст»**, там нужно будет заменить виджет
