...
- планы на 2023й год
  - !!! пересмотреть и переработать UX и UI в свете того, что Oxxxy стал ещё и редактором коллажей
  ...
  - добавить возможность исправления скриншота после его создания (сброс в один бинарный файл фона, пометок и их данных для последующего чтения)
