...
### Версия 0.94 (дата не определена)
  ...
  - внедрение PZMT (Canvas Panning & Zooming и Elements Multiselect & Transformations) для холста в редакторе (продолжение)
      ...
      - инструмент «Лупа», улучшения
          ...
          - замечание: при неоднородном масштабировании второй пометки касательные линии отрываются пот первой пометки. Чтобы этого избежать нужно производить только однородное масштабирование для второй пометки
