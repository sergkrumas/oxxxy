...
Проверка на баги для версии 0.95
  ...
  - пометки инструмента «Текст»
      ...
      - область выделения текстового объекта должна соответствовать фактическому видимому размеру
      - сопровождающая стрелка обновляется при нанесении и при трансформациях текста
  ...
  - копирование пометок через `Ctrl+C` и `Ctrl+V`
