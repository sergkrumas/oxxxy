...
- Версия Python: 3.10.6 и выше (хотя изначально всё писалось на Python 3.7 и, теоретически, должно запускаться и на Python 3.7).
- Установка всех зависимостей через **pip**, прописанных в файле **dependencies.txt**
...
Для начала работы нет необходимости где-то регистрироваться, нужно только установить python, Pyqt5 и ряд других зависимостей, описанных в файле `dependencies.txt`.
...
- 0.91
  ...
  - инструмент Линия теперь может рисовать ломанные линии при удерживании клавиши Ctrl
...
- переделаю виджет для инструмента **Текст**, чтобы в режиме редактирования при повороте через клавиши F5-F6 одновременно не отображались повёрнутая и неповёрнутая версии
- выделение объектов для инструмента **Перемещение** будет реализовано намного аккуратней, чем сейчас
- возможность записывать видео со звуком или гифки в захваченной области
- тест и обеспечение в виртуальном окружении
